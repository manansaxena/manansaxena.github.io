...
Summary: an example of a blog post with table of contents
Tags: 
  - formatting
  - toc
...
[TOC]
```
to the location in the Markdown document where you want
the table. The table of contents will be automatically 
